...
constexpr double Distance_btw_Src_Obs { 2.0e3 };
constexpr double X_SOURCE {(RX/2.0) - Distance_btw_Src_Obs/2.0};
constexpr double Y_SOURCE {Y_SURFACE - 15.0e3}; //ISC
...
constexpr double TIME_SCALE ( 0.2 ); // rt = 1400/s

// 0.1-10Hz
// constexpr int P_ORDER (5000);
// constexpr double TIME_SCALE ( 2.0 ); // rt = 1400/s
