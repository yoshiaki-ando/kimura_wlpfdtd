...
constexpr double DF { 0.002 }; //基本周波数(逆数がRT)
...
/***********Wenchuan***********/
constexpr double RX {2000.0e3};
constexpr double RY {100.0e3};
constexpr double DX {RX/400};
...
constexpr double Distance_btw_Src_Obs { 1440.0e3 };
constexpr double X_SOURCE {(RX/2.0) - Distance_btw_Src_Obs/2.0};
constexpr double Y_SOURCE {Y_SURFACE - 10.0e3}; //ISC
...
constexpr double r_target { 1.5 }; // 不均一セルの増加比
